...
##CHANGE FULL NAMES INTO ABBREVIATIONS##

# Replace the values in the "Antibiotic column" for three letter abbreviations
...
ecoli_count['Antibiotic'] = ecoli_count['Antibiotic'].replace({
    ...
    'Trimethoprim/Sulfamethoxazole': 'TMT/SUL'
})

# For kleb_count dataframe
kleb_count['Antibiotic'] = kleb_count['Antibiotic'].replace({
    'Amikacin': 'AMK',
    'Ampicillin ': 'AMP',
    'Azithromycin ': 'AZM',
...
# For pmirabilis_count dataframe
ecloacae_count['Antibiotic'] = ecloacae_count['Antibiotic'].replace({
    'Amikacin': 'AMK',
    'Ampicillin ': 'AMP',
    'Azithromycin ': 'AZM',
...
# For alpha strp count dataframe
alphastrep_count['Antibiotic'] = alphastrep_count['Antibiotic'].replace({
    'Amikacin': 'AMK',
    'Ampicillin ': 'AMP',
    'Azithromycin ': 'AZM',
...
#Create a new dataframe for each "X_count" dataframes, and add a new column named "Bacteria" with the name of the bacteria
ecoli_counted = ecoli_count
ecoli_counted['Bacteria'] = "Ecoli"
kleb_counted = kleb_count
kleb_counted['Bacteria'] = "Kleb"
ecloacae_counted = ecloacae_count
ecloacae_counted['Bacteria'] = "Ecloacae"
pmirabilis_counted = pmirabilis_count
pmirabilis_counted['Bacteria'] = "Pmirabilis"
pagglom_counted = pagglom_count
pagglom_counted['Bacteria'] = "Pagglom"
pvulgaris_counted = pvulgaris_count
pvulgaris_counted['Bacteria'] = "Pvulgaris"
alphastrep_counted = alphastrep_count
alphastrep_counted['Bacteria'] = "Alphastrep"
pmirabilis_counted = pmirabilis_count
pmirabilis_counted['Bacteria'] = "Pmirabilis"
betastrep_counted = betastrep_count
betastrep_counted['Bacteria'] = "Betastrep"

#Concatenate all the dataframes into a single dataframe
all_bacteria = pd.concat([ecoli_counted, kleb_counted, ecloacae_counted, pmirabilis_counted, pagglom_counted, pvulgaris_counted, alphastrep_counted, betastrep_counted], ignore_index=True)

#Save the "all_bacteria" dataframe into a csv file
all_bacteria.to_csv("C:/Users/Mariano/Desktop/FREE/Datos Bejnamin/all_bacteria.csv", index=False)
...
for group, size in zip(["A", "B", "C", "D", "E", "F", "G", "H", "I", "J", "K", "L"], ECOLIGROUPS_SIZE):
    ...
    x2 = np.linspace(ECOLIANGLES[offset], ECOLIANGLES[offset + PAD - 1], num=50)
...
for group, size in zip(["A", "B", "C", "D", "E", "F", "G", "H", "I", "J", "K", "L"], ECLOACAEGROUPS_SIZE):
    ...
    ax.text(
     ...
     # Add reference lines at 20, 40, 60, and 80
    x2 = np.linspace(ECLOACAEANGLES[offset], ECLOACAEANGLES[offset + PAD - 1], num=50)
    ax.plot(x2, [20] * 50, color="#bebebe", lw=0.8)
    ax.plot(x2, [40] * 50, color="#bebebe", lw=0.8)
    ax.plot(x2, [60] * 50, color="#bebebe", lw=0.8)
    ax.plot(x2, [80] * 50, color="#bebebe", lw=0.8)
...
for group, size in zip(["A", "B", "C", "D", "E", "F", "G", "H", "I", "J", "K", "L"], PAGGLOMGROUPS_SIZE):
    ...
    ax.text(
     ...
     # Add reference lines at 20, 40, 60, and 80
    x2 = np.linspace(PAGGLOMANGLES[offset], PAGGLOMANGLES[offset + PAD - 1], num=50)
    ax.plot(x2, [20] * 50, color="#bebebe", lw=0.8)
    ax.plot(x2, [40] * 50, color="#bebebe", lw=0.8)
    ax.plot(x2, [60] * 50, color="#bebebe", lw=0.8)
    ax.plot(x2, [80] * 50, color="#bebebe", lw=0.8)
...
for group, size in zip(["A", "B", "C", "D", "E", "F", "G", "H", "I", "J", "K", "L"], PMIRABILISGROUPS_SIZE):
    ...
    ax.text(
     ...
     # Add reference lines at 20, 40, 60, and 80
    x2 = np.linspace(PMIRABILISANGLES[offset], PMIRABILISANGLES[offset + PAD - 1], num=50)
    ax.plot(x2, [20] * 50, color="#bebebe", lw=0.8)
    ax.plot(x2, [40] * 50, color="#bebebe", lw=0.8)
    ax.plot(x2, [60] * 50, color="#bebebe", lw=0.8)
    ax.plot(x2, [80] * 50, color="#bebebe", lw=0.8)
...
for group, size in zip(["A", "B", "C", "D", "E", "F", "G", "H", "I", "J", "K", "L"], PVULGARISGROUPS_SIZE):
    ...
    ax.text(
     ...
     # Add reference lines at 20, 40, 60, and 80
    x2 = np.linspace(PVULGARISANGLES[offset], PVULGARISANGLES[offset + PAD - 1], num=50)
    ax.plot(x2, [20] * 50, color="#bebebe", lw=0.8)
    ax.plot(x2, [40] * 50, color="#bebebe", lw=0.8)
    ax.plot(x2, [60] * 50, color="#bebebe", lw=0.8)
    ax.plot(x2, [80] * 50, color="#bebebe", lw=0.8)
...
for group, size in zip(["A", "B", "C", "D", "E", "F", "G", "H", "I", "J", "K", "L"], KLEBGROUPS_SIZE):
    ...
    ax.text(
     ...
     # Add reference lines at 20, 40, 60, and 80
    x2 = np.linspace(KLEBANGLES[offset], KLEBANGLES[offset + PAD - 1], num=50)
    ax.plot(x2, [20] * 50, color="#bebebe", lw=0.8)
    ax.plot(x2, [40] * 50, color="#bebebe", lw=0.8)
    ax.plot(x2, [60] * 50, color="#bebebe", lw=0.8)
    ax.plot(x2, [80] * 50, color="#bebebe", lw=0.8)
...
for group, size in zip(["A", "B", "C", "D", "E", "F", "G", "H", "I", "J", "K", "L", "M"], ALPHASTREPGROUPS_SIZE):
    ...
    ax.text(
     ...
     # Add reference lines at 20, 40, 60, and 80
    x2 = np.linspace(ALPHASTREPANGLES[offset], ALPHASTREPANGLES[offset + PAD - 1], num=50)
    ax.plot(x2, [20] * 50, color="#bebebe", lw=0.8)
    ax.plot(x2, [40] * 50, color="#bebebe", lw=0.8)
    ax.plot(x2, [60] * 50, color="#bebebe", lw=0.8)
    ax.plot(x2, [80] * 50, color="#bebebe", lw=0.8)
...
for group, size in zip(["A", "B", "C", "D", "E", "F", "G", "H", "I", "J", "K", "L", "M"], BETASTREPGROUPS_SIZE):
    ...
    ax.text(
     ...
     # Add reference lines at 20, 40, 60, and 80
    x2 = np.linspace(BETASTREPANGLES[offset], BETASTREPANGLES[offset + PAD - 1], num=50)
    ax.plot(x2, [20] * 50, color="#bebebe", lw=0.8)
    ax.plot(x2, [40] * 50, color="#bebebe", lw=0.8)
    ax.plot(x2, [60] * 50, color="#bebebe", lw=0.8)
    ax.plot(x2, [80] * 50, color="#bebebe", lw=0.8)
